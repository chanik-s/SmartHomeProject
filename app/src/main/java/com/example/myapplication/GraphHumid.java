...
public class GraphHumid extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       // arrayListHumid=(ArrayList<Sensor>) intent.getSerializableExtra("sensor list");
        ...
        xAxis.setValueFormatter(new DateAxisValueFormatter("MM-dd HH:mm",baseDate));
    ...
    static public class DateAxisValueFormatter extends ValueFormatter implements IAxisValueFormatter {
